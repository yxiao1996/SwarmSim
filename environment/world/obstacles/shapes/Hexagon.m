classdef Hexagon < obstacle
    ...
    methods
        function obj = Hexagon(center,radius,orient)
            %TRIANGLE 
            obj.position = center;
            ...
            v4 = points(4,:)-points(5,:);
            v4 = [-v4(2) v4(1)];
            v4 = v4/sqrt(dot(v4,v4));
            
            v5 = points(5,:)-points(6,:);
            v5 = [-v5(2) v5(1)];
            v5 = v5/sqrt(dot(v5,v5));
            
            v6 = points(6,:)-points(1,:);
            v6 = [-v6(2) v6(1)];
            v6 = v6/sqrt(dot(v6,v6));
            obj.units = [v1;v2;v3;v4;v5;v6];
        end
